...
export interface ApiContentPageContentPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    detailSections: Schema.Attribute.Component<'shared.content-section', true>;
    featuredImage: Schema.Attribute.Media<'images'>;
    hero: Schema.Attribute.Component<'shared.hero', false>;
    insightItems: Schema.Attribute.Component<'shared.insight-item', true>;
    ...
    > &
      Schema.Attribute.Private;
    menuGroup: Schema.Attribute.String;
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaCards: Schema.Attribute.Component<'shared.cta-card', true>;
    defaultSeo: Schema.Attribute.Component<'shared.seo', false>;
    footerLegalText: Schema.Attribute.JSON;
    footerPrimaryLinks: Schema.Attribute.Component<'shared.link', true>;
    footerSecondaryLinks: Schema.Attribute.Component<'shared.link', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    partnerLogos: Schema.Attribute.Media<'images', true>;
    primaryNavigation: Schema.Attribute.Component<'navigation.menu-link', true>;
    publishedAt: Schema.Attribute.DateTime;
    siteContactEmail: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    versionLabel: Schema.Attribute.Enumeration<['v1', 'v2']> &
